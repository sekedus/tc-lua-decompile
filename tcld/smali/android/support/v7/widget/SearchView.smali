...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, La/c/g/b/a;->searchViewStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, La/c/g/h/z0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/SearchView;->C:[I
    ...
    sget-object v0, La/c/g/b/j;->SearchView:[I
    ...
    sget p2, La/c/g/b/j;->SearchView_layout:I

    sget p3, La/c/g/b/g;->abc_search_view:I

    invoke-virtual {v1, p2, p3}, La/c/g/h/y1;->l(II)I
    ...
    sget p1, La/c/g/b/f;->search_src_text:I
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/SearchView$SearchAutoComplete;
    ...
    sget p1, La/c/g/b/f;->search_edit_frame:I
    ...
    sget p1, La/c/g/b/f;->search_plate:I

    invoke-virtual {p0, p1}, Landroid/view/ViewGroup;->findViewById(I)Landroid/view/View;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->s:Landroid/view/View;

    sget p1, La/c/g/b/f;->submit_area:I
    ...
    sget p1, La/c/g/b/f;->search_button:I
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->u:Landroid/widget/ImageView;

    sget p1, La/c/g/b/f;->search_go_btn:I
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->v:Landroid/widget/ImageView;

    sget p1, La/c/g/b/f;->search_close_btn:I
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->w:Landroid/widget/ImageView;

    sget p1, La/c/g/b/f;->search_voice_btn:I
    ...
    sget p1, La/c/g/b/f;->search_mag_icon:I
    ...
    sget p2, La/c/g/b/j;->SearchView_queryBackground:I

    invoke-virtual {v1, p2}, La/c/g/h/y1;->f(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-static {p1, p2}, La/c/f/h/n;->M(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->t:Landroid/view/View;

    sget p2, La/c/g/b/j;->SearchView_submitBackground:I
    ...
    sget p2, La/c/g/b/j;->SearchView_searchIcon:I
    ...
    sget p2, La/c/g/b/j;->SearchView_goIcon:I
    ...
    sget p2, La/c/g/b/j;->SearchView_closeIcon:I
    ...
    sget p2, La/c/g/b/j;->SearchView_voiceIcon:I
    ...
    sget p1, La/c/g/b/j;->SearchView_searchHintIcon:I

    invoke-virtual {v1, p1}, La/c/g/h/y1;->f(I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->F:Landroid/graphics/drawable/Drawable;
    ...
    sget v0, La/c/g/b/h;->abc_searchview_description_search:I

    invoke-virtual {p2, v0}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object p2

    invoke-static {p1, p2}, La/c/c/j/b;->z0(Landroid/view/View;Ljava/lang/CharSequence;)V

    sget p1, La/c/g/b/j;->SearchView_suggestionRowLayout:I

    sget p2, La/c/g/b/g;->abc_search_dropdown_item_icons_2line:I

    invoke-virtual {v1, p1, p2}, La/c/g/h/y1;->l(II)I

    move-result p1

    iput p1, p0, Landroid/support/v7/widget/SearchView;->G:I

    sget p1, La/c/g/b/j;->SearchView_commitIcon:I

    invoke-virtual {v1, p1, v2}, La/c/g/h/y1;->l(II)I
    ...
    iget-object p2, p0, Landroid/support/v7/widget/SearchView;->l0:Landroid/view/View$OnClickListener;
    ...
    iget-object p2, p0, Landroid/support/v7/widget/SearchView;->q0:Landroid/text/TextWatcher;

    invoke-virtual {p1, p2}, Landroid/widget/AutoCompleteTextView;->addTextChangedListener(Landroid/text/TextWatcher;)V

    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    iget-object p2, p0, Landroid/support/v7/widget/SearchView;->n0:Landroid/widget/TextView$OnEditorActionListener;
    ...
    iget-object p2, p0, Landroid/support/v7/widget/SearchView;->o0:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iget-object p2, p0, Landroid/support/v7/widget/SearchView;->p0:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    iget-object p2, p0, Landroid/support/v7/widget/SearchView;->m0:Landroid/view/View$OnKeyListener;

    invoke-virtual {p1, p2}, Landroid/widget/AutoCompleteTextView;->setOnKeyListener(Landroid/view/View$OnKeyListener;)V

    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    new-instance p2, Landroid/support/v7/widget/SearchView$d;

    invoke-direct {p2, p0}, Landroid/support/v7/widget/SearchView$d;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    sget p1, La/c/g/b/j;->SearchView_iconifiedByDefault:I

    invoke-virtual {v1, p1, p3}, La/c/g/h/y1;->a(IZ)Z

    move-result p1

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/SearchView;->setIconifiedByDefault(Z)V

    sget p1, La/c/g/b/j;->SearchView_android_maxWidth:I

    const/4 p2, -0x1

    invoke-virtual {v1, p1, p2}, La/c/g/h/y1;->e(II)I
    ...
    :cond_0
    sget p1, La/c/g/b/j;->SearchView_defaultQueryHint:I

    invoke-virtual {v1, p1}, La/c/g/h/y1;->m(I)Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->K:Ljava/lang/CharSequence;

    sget p1, La/c/g/b/j;->SearchView_queryHint:I
    ...
    sget p1, La/c/g/b/j;->SearchView_android_imeOptions:I

    invoke-virtual {v1, p1, p2}, La/c/g/h/y1;->j(II)I
    ...
    :cond_1
    sget p1, La/c/g/b/j;->SearchView_android_inputType:I
    ...
    :cond_2
    sget p1, La/c/g/b/j;->SearchView_android_focusable:I
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->I:Landroid/content/Intent;

    const/high16 p2, 0x10000000

    invoke-virtual {p1, p2}, Landroid/content/Intent;->addFlags(I)Landroid/content/Intent;

    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->I:Landroid/content/Intent;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->J:Landroid/content/Intent;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->y:Landroid/view/View;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/SearchView;->I(Z)V
...
.method private getPreferredHeight()I
    ...
    sget v1, La/c/g/b/d;->abc_search_view_preferred_height:I
...
.method private getPreferredWidth()I
    ...
    sget v1, La/c/g/b/d;->abc_search_view_preferred_width:I
...
.method public A()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/SearchView;->I(Z)V
...
.method public B()V
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/SearchView$m;->a(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v2, v1, v0}, Landroid/support/v7/widget/SearchView;->v(ILjava/lang/String;Ljava/lang/String;)V
...
.method public C(ILandroid/view/KeyEvent;)Z
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->S:La/c/f/i/c;
    ...
    :goto_1
    iget-object p2, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/SearchView$SearchAutoComplete;
    ...
    sget-object p1, Landroid/support/v7/widget/SearchView;->r0:Landroid/support/v7/widget/SearchView$k;

    iget-object p2, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    .line 1
    iget-object p1, p1, Landroid/support/v7/widget/SearchView$k;->c:Ljava/lang/reflect/Method;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/SearchView;->x(I)Z
...
.method public final I(Z)V
    ...
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/SearchView;->H(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/SearchView;->J(Z)V
...
.method public getSuggestionsAdapter()La/c/f/i/c;
    .locals 1
...
.method public onLayout(ZIIII)V
    ...
    invoke-super/range {p0 .. p5}, La/c/g/h/z0;->onLayout(ZIIII)V
...
.method public onMeasure(II)V
    ...
    .line 2
    invoke-super {p0, p1, p2}, La/c/g/h/z0;->onMeasure(II)V
...
.method public onWindowFocusChanged(Z)V
    ...
    .line 1
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->i0:Ljava/lang/Runnable;
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/SearchView;->I(Z)V
...
.method public setQueryRefinementEnabled(Z)V
    ...
    instance-of v1, v0, La/c/g/h/s1;

    if-eqz v1, :cond_1

    check-cast v0, La/c/g/h/s1;
...
.method public setSearchableInfo(Landroid/app/SearchableInfo;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->S:La/c/f/i/c;

    if-eqz p1, :cond_1

    invoke-virtual {p1, v2}, La/c/f/i/c;->b(Landroid/database/Cursor;)V
    ...
    invoke-direct {p1, v3, p0, v4, v5}, La/c/g/h/s1;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->S:La/c/f/i/c;
...
.method public setSuggestionsAdapter(La/c/f/i/c;)V
    .locals 1
...
.method public v(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v7/widget/SearchView;->r(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/content/Intent;
...
.method public x(I)Z
    ...
    .line 1
    iget-object v2, p0, Landroid/support/v7/widget/SearchView;->S:La/c/f/i/c;

    .line 2
    iget-object v9, v2, La/c/f/i/c;->d:Landroid/database/Cursor;
    ...
    .line 4
    invoke-static {v9, v2}, La/c/g/h/s1;->e(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    if-nez v2, :cond_2

    iget-object v2, p0, Landroid/support/v7/widget/SearchView;->g0:Landroid/app/SearchableInfo;
    ...
    invoke-static {v9, v2}, La/c/g/h/s1;->i(Landroid/database/Cursor;I)Ljava/lang/String;
    ...
    invoke-static {v9, v4}, La/c/g/h/s1;->i(Landroid/database/Cursor;I)Ljava/lang/String;
    ...
    .line 10
    invoke-virtual/range {v2 .. v8}, Landroid/support/v7/widget/SearchView;->r(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/content/Intent;
...
.method public y(I)Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->S:La/c/f/i/c;

    .line 2
    iget-object v1, v1, La/c/f/i/c;->d:Landroid/database/Cursor;
    ...
    invoke-virtual {p1, v1}, La/c/f/i/c;->c(Landroid/database/Cursor;)Ljava/lang/CharSequence;
