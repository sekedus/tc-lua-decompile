...
.field public final x:La/c/f/h/j;

.field public final y:La/c/f/h/g;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/graphics/Rect;
    ...
    new-instance p1, La/c/f/h/j;

    invoke-direct {p1, p0}, La/c/f/h/j;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->x:La/c/f/h/j;

    new-instance p1, La/c/f/h/g;

    invoke-direct {p1, p0}, La/c/f/h/g;-><init>(Landroid/view/View;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->y:La/c/f/h/g;
...
.method public static s(Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-static {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->s(Landroid/view/View;Landroid/view/View;)Z
...
.method public A(II)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:La/c/f/h/g;

    invoke-virtual {v0, p1, p2}, La/c/f/h/g;->g(II)Z
...
.method public a(I)V
    ...
    invoke-virtual {v0, p1}, La/c/f/h/g;->h(I)V
...
.method public b(I)Z
    ...
    invoke-virtual {p0, v1, v2, v4}, Landroid/support/v4/widget/NestedScrollView;->t(Landroid/view/View;II)Z
    ...
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/NestedScrollView;->g(I)V
    ...
    invoke-virtual {p0, v0, v3, v1}, Landroid/support/v4/widget/NestedScrollView;->t(Landroid/view/View;II)Z
...
.method public computeScroll()V
    ...
    invoke-virtual/range {v4 .. v9}, Landroid/support/v4/widget/NestedScrollView;->e(II[I[II)Z
    ...
    invoke-virtual/range {v4 .. v12}, Landroid/support/v4/widget/NestedScrollView;->v(IIIIIIII)Z
    ...
    invoke-virtual/range {v5 .. v11}, Landroid/support/v4/widget/NestedScrollView;->f(IIII[II)Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/widget/NestedScrollView;->j()V
    ...
    :cond_5
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/NestedScrollView;->r(I)Z
    ...
    invoke-virtual {v0, v2}, La/c/f/h/g;->h(I)V
...
.method public dispatchNestedFling(FFZ)Z
    ...
    invoke-virtual {v0, p1, p2, p3}, La/c/f/h/g;->a(FFZ)Z
...
.method public dispatchNestedPreFling(FF)Z
    ...
    invoke-virtual {v0, p1, p2}, La/c/f/h/g;->b(FF)Z
...
.method public e(II[I[II)Z
    ...
    invoke-virtual/range {v0 .. v5}, La/c/f/h/g;->c(II[I[II)Z
...
.method public f(IIII[II)Z
    ...
    invoke-virtual/range {v0 .. v6}, La/c/f/h/g;->d(IIII[II)Z
...
.method public final g(I)V
    ...
    invoke-virtual {p0, v1, p1}, Landroid/support/v4/widget/NestedScrollView;->z(II)V
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:La/c/f/h/j;
...
.method public final h()V
    ...
    invoke-virtual {p0}, Landroid/support/v4/widget/NestedScrollView;->w()V

    .line 1
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->y:La/c/f/h/g;

    invoke-virtual {v1, v0}, La/c/f/h/g;->h(I)V
...
.method public hasNestedScrollingParent()Z
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/NestedScrollView;->r(I)Z
...
.method public i(Landroid/view/View;Landroid/view/View;II)V
    ...
    iget-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->x:La/c/f/h/j;
...
.method public isNestedScrollingEnabled()Z
    ...
    .line 1
    iget-boolean v0, v0, La/c/f/h/g;->d:Z
...
.method public l(Landroid/view/View;I)V
    ...
    .line 1
    iput v0, p1, La/c/f/h/j;->a:I

    .line 2
    iget-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->y:La/c/f/h/g;

    invoke-virtual {p1, p2}, La/c/f/h/g;->h(I)V
...
.method public o(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, v5, v1, v0}, Landroid/support/v4/widget/NestedScrollView;->x(III)Z
    ...
    :cond_b
    invoke-virtual {p0, v3}, Landroid/support/v4/widget/NestedScrollView;->q(I)Z
    ...
    :cond_d
    invoke-virtual {p0, v5}, Landroid/support/v4/widget/NestedScrollView;->q(I)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->u(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {p1, v3}, La/c/f/h/g;->h(I)V
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p2, p0}, Landroid/support/v4/widget/NestedScrollView;->s(Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {p0, p2}, Landroid/support/v4/widget/NestedScrollView;->y(Landroid/view/View;)V
    ...
    iget-object p4, p0, Landroid/support/v4/widget/NestedScrollView;->w:Landroid/support/v4/widget/NestedScrollView$c;
    ...
    iput-object p2, p0, Landroid/support/v4/widget/NestedScrollView;->w:Landroid/support/v4/widget/NestedScrollView$c;
    ...
    invoke-static {p2, p5, p1}, Landroid/support/v4/widget/NestedScrollView;->c(III)I
...
.method public onNestedScroll(Landroid/view/View;IIII)V
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v4/widget/NestedScrollView;->k(Landroid/view/View;IIIII)V
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    .line 3
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/widget/NestedScrollView;->A(II)Z
...
.method public onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v1, v2, v3}, Landroid/support/v4/widget/NestedScrollView;->t(Landroid/view/View;II)Z
...
.method public onScrollChanged(IIII)V
    ...
    iget-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->A:Landroid/support/v4/widget/NestedScrollView$b;

    if-eqz p1, :cond_0

    check-cast p1, La/c/g/a/d;

    .line 1
    iget-object p2, p1, La/c/g/a/d;->a:Landroid/view/View;

    iget-object p1, p1, La/c/g/a/d;->b:Landroid/view/View;

    invoke-static {p0, p2, p1}, Landroid/support/v7/app/AlertController;->c(Landroid/view/View;Landroid/view/View;Landroid/view/View;)V
...
.method public onSizeChanged(IIII)V
    ...
    invoke-virtual {p0, p1, p2, p4}, Landroid/support/v4/widget/NestedScrollView;->t(Landroid/view/View;II)Z
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->g(I)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_2
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/widget/NestedScrollView;->u(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual/range {v0 .. v8}, Landroid/support/v4/widget/NestedScrollView;->v(IIIIIIII)Z

    move-result v0

    if-eqz v0, :cond_d

    invoke-virtual {v9, v12}, Landroid/support/v4/widget/NestedScrollView;->r(I)Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/NestedScrollView;->j()V
    ...
    invoke-static {v0, v1, v2}, La/c/c/j/b;->i0(Landroid/widget/EdgeEffect;FF)V
    ...
    invoke-virtual {v9, v0}, Landroid/support/v4/widget/NestedScrollView;->p(I)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/NestedScrollView;->h()V
    ...
    invoke-virtual {v9, v1, v12}, Landroid/support/v4/widget/NestedScrollView;->A(II)Z
...
.method public q(I)Z
    ...
    invoke-virtual {p0, p1, v1, v0}, Landroid/support/v4/widget/NestedScrollView;->x(III)Z
...
.method public r(I)Z
    ...
    .line 1
    invoke-virtual {v0, p1}, La/c/f/h/g;->e(I)Landroid/view/ViewParent;
...
.method public requestChildRectangleOnScreen(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    .line 1
    invoke-virtual {p0, p2}, Landroid/support/v4/widget/NestedScrollView;->d(Landroid/graphics/Rect;)I
    ...
    :cond_1
    invoke-virtual {p0, p2, p1}, Landroid/support/v4/widget/NestedScrollView;->z(II)V
...
.method public scrollTo(II)V
    ...
    invoke-static {p1, v2, v3}, Landroid/support/v4/widget/NestedScrollView;->c(III)I

    move-result p1

    invoke-static {p2, v4, v0}, Landroid/support/v4/widget/NestedScrollView;->c(III)I
...
.method public setNestedScrollingEnabled(Z)V
    ...
    .line 1
    iget-boolean v1, v0, La/c/f/h/g;->d:Z

    if-eqz v1, :cond_0

    iget-object v1, v0, La/c/f/h/g;->c:Landroid/view/View;

    invoke-static {v1}, La/c/f/h/n;->X(Landroid/view/View;)V

    :cond_0
    iput-boolean p1, v0, La/c/f/h/g;->d:Z
...
.method public startNestedScroll(I)Z
    ...
    invoke-virtual {v0, p1, v1}, La/c/f/h/g;->g(II)Z
...
.method public stopNestedScroll()V
    ...
    invoke-virtual {v0, v1}, La/c/f/h/g;->h(I)V
...
.method public v(IIIIIIII)Z
    ...
    invoke-virtual {p0, v5}, Landroid/support/v4/widget/NestedScrollView;->r(I)Z

    move-result v7

    if-nez v7, :cond_c

    iget-object v7, v0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/widget/OverScroller;
...
.method public final x(III)Z
    ...
    .line 2
    :goto_6
    invoke-virtual {v0, v2}, Landroid/support/v4/widget/NestedScrollView;->g(I)V
