...
.method public abstract B(Landroid/view/View;Landroid/view/View;ZZ)Z
.end method

.method public g(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    .locals 1

    check-cast p3, La/c/c/n/a;

    invoke-interface {p3}, La/c/c/n/a;->a()Z

    move-result p1

    invoke-virtual {p0, p1}, Landroid/support/design/transformation/ExpandableBehavior;->A(Z)Z
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Landroid/support/design/transformation/ExpandableBehavior;->B(Landroid/view/View;Landroid/view/View;ZZ)Z
...
.method public j(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-static {p2}, La/c/f/h/n;->B(Landroid/view/View;)Z
    ...
    invoke-virtual {p0, p1, p2, v3}, Landroid/support/design/widget/CoordinatorLayout$c;->d(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z

    move-result v4

    if-eqz v4, :cond_0

    check-cast v3, La/c/c/n/a;
    ...
    .line 2
    invoke-interface {v3}, La/c/c/n/a;->a()Z
    ...
    invoke-direct {v1, p0, p2, p1, v3}, Landroid/support/design/transformation/ExpandableBehavior$a;-><init>(Landroid/support/design/transformation/ExpandableBehavior;Landroid/view/View;ILa/c/c/n/a;)V
