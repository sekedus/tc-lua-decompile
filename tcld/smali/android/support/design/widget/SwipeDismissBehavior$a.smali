...
.method public j(Landroid/view/View;IIII)V
    ...
    invoke-static {v0, p2, p3}, Landroid/support/design/widget/SwipeDismissBehavior;->B(FFF)F
...
.method public k(Landroid/view/View;FF)V
    ...
    iget-object p2, p2, Landroid/support/design/widget/SwipeDismissBehavior;->a:La/c/f/i/l;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result p3

    invoke-virtual {p2, v0, p3}, La/c/f/i/l;->v(II)Z

    move-result p2

    if-eqz p2, :cond_9

    new-instance p2, Landroid/support/design/widget/SwipeDismissBehavior$c;
    ...
    invoke-direct {p2, p3, p1, v1}, Landroid/support/design/widget/SwipeDismissBehavior$c;-><init>(Landroid/support/design/widget/SwipeDismissBehavior;Landroid/view/View;Z)V
